...
public class NumberAwareFileNameComparator implements Comparator<File> {
	public static final NumberAwareFileNameComparator INSTANCE =
			new NumberAwareFileNameComparator();

	private static final Pattern PATTERN = Pattern.compile("(\\D*)(\\d*)");

	private NumberAwareFileNameComparator() {
	}
